...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int sample_rate) {
		...
		float fConst1 = std::tan(18849.557f / fConst0);
		float fConst2 = std::sqrt(4.0f * mydsp_faustpower2_f(fConst0) * std::tan(267.03537f / fConst0) * fConst1);
		float fConst3 = mydsp_faustpower2_f(fConst2);
		fConst4 = 1.0f / fConst0;
		float fConst5 = mydsp_faustpower3_f(fConst4) * fConst3;
		float fConst6 = fConst0 * fConst1;
		float fConst7 = 2.0f * fConst6 - 0.5f * (fConst3 / fConst6);
		float fConst8 = fConst7 * (8.0f / fConst0 + 2.0f * fConst5);
		float fConst9 = mydsp_faustpower2_f(fConst7);
		float fConst10 = mydsp_faustpower2_f(fConst4);
		float fConst11 = mydsp_faustpower4_f(fConst4) * mydsp_faustpower4_f(fConst2);
		float fConst12 = fConst11 + fConst10 * (4.0f * fConst9 + 8.0f * fConst3);
		fConst13 = fConst12 + (16.0f - fConst8);
		float fConst14 = 4.0f * fConst5;
		float fConst15 = 16.0f / fConst0;
		float fConst16 = 4.0f * fConst11;
		...
		float fConst20 = fConst8 + fConst12 + 16.0f;
		fConst21 = 1.0f / fConst20;
		float fConst22 = 2.0f * (fConst7 / fConst0);
		float fConst23 = fConst10 * fConst3;
		fConst24 = fConst23 + (4.0f - fConst22);
		fConst25 = 2.0f * fConst23 + -8.0f;
		float fConst26 = fConst23 + fConst22 + 4.0f;
		fConst27 = 1.0f / fConst26;
		fConst28 = 5e+01f / fConst0;
		float fConst29 = std::max<float>(0.0f, std::min<float>(2047.0f, 2e+03f * fConst0));
		iConst30 = int(fConst29);
		iConst31 = iConst30 + 1;
		float fConst32 = std::floor(fConst29);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addHorizontalSlider("Pop Trigger", &fHslider0, FAUSTFLOAT(0.004f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.001f));
		ui_interface->addHorizontalSlider("Scratch Trigger", &fHslider1, FAUSTFLOAT(0.4f), FAUSTFLOAT(0.0f), FAUSTFLOAT(1.0f), FAUSTFLOAT(0.01f));
		ui_interface->closeBox();
	}
	...
	virtual void compute(int count, FAUSTFLOAT** RESTRICT inputs, FAUSTFLOAT** RESTRICT outputs) {
		...
		for (int i0 = 0; i0 < count; i0 = i0 + 1) {
			...
			float fTemp4 = ((iTemp0) ? 0.0f : fRec5[1] + fConst4 * float(input0[i0]));
			fRec5[0] = fTemp4 - std::floor(fTemp4);
			iRec7[0] = 1103515245 * iRec7[1] + 12345;
			fRec6[0] = fConst38 * float(iRec7[0]) + fConst36 * fRec6[1];
			fRec1[0] = 0.4f * fRec6[0] + 0.04f * fRec5[0] * fRec4[0] + fConst37 * fRec3[0] * (fTemp3 - fConst34 * fVec2[(IOTA0 - iConst30) & 4095] - fConst33 * fVec2[(IOTA0 - iConst31) & 4095]) - fConst27 * (fConst25 * fRec1[1] + fConst24 * fRec1[2]);
			fRec0[0] = fConst39 * (fRec1[0] - fRec1[2]) - fConst21 * (fConst19 * fRec0[1] + fConst18 * fRec0[2] + fConst17 * fRec0[3] + fConst13 * fRec0[4]);
			float fTemp5 = fConst40 * (4.0f * (fRec0[0] + fRec0[4]) - 8.0f * fRec0[2]);
	...
	FAUST_ADDHORIZONTALSLIDER("Pop Trigger", fHslider0, 0.004f, 0.0f, 1.0f, 0.001f);
	FAUST_ADDHORIZONTALSLIDER("Scratch Trigger", fHslider1, 0.4f, 0.0f, 1.0f, 0.01f);

	#define FAUST_LIST_ACTIVES(p) \
		p(HORIZONTALSLIDER, Pop_Trigger, "Pop Trigger", fHslider0, 0.004f, 0.0f, 1.0f, 0.001f) \
		p(HORIZONTALSLIDER, Scratch_Trigger, "Scratch Trigger", fHslider1, 0.4f, 0.0f, 1.0f, 0.01f) \
